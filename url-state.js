...
export const URL_STATE_VALUES = Object.freeze({
  ...
  company: Object.freeze([
    ...
    "qualcomm", "intel", "lam-research", "kla", "tokyo-electron", "mediatek",
    "apple", "adobe", "tencent", "alibaba", "naver", "samsung-sds", "baidu",
    "kia", "general-motors", "ford", "bmw", "mercedes-benz", "honda", "lg-chem",
